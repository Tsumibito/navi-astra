...
export const homeContent = {
  ru: {
    ...
    mission: {
      ...
      items: [
        ...
        { icon: '/cgi/asset/65f9b1ff4a7f117a3441b5ea_ship_nJ_S58ya0Ots2jtZLdcJY.png', text: 'Делаем доступным [[незабываемый отдых под парусом]], помогая нашим клиентам арендовать яхту в любом регионе мира, как со шкипером так и без.' },
    ...
    faq: {
      ...
      items: [
        { q: 'Где вы находитесь?', a: 'Наш главный офис находится во Франции, в городе Ля-Рошель. Наш адрес вы найдете в футере сайта. Также у нас есть тренировочные базы в Турции, Черногории и Испании, откуда обычно выходят наши группы морской практики.' },
        ...
        { q: 'Какие виды оплаты вы принимаете и в какой валюте?', a: 'MON NAVI SARL французская компания, расположенная в городе Lagord в департаменте Charente-Maritime на Атлантическом побережье Франции. Обычно мы принимаем SEPA платежи в евро на наш IBAN счет либо оплаты картой через Stripe или PayPal.' },
      ...
      ctaBody: 'Свяжитесь с нами, наши менеджеры будут рады вам помочь',
  ...
  ua: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Які види оплати ви приймаєте і в якій валюті?', a: 'MON NAVI SARL французька компанія, розташована в місті Lagord у департаменті Charente-Maritime на Атлантичному узбережжі Франції. Зазвичай ми приймаємо SEPA платежі в євро на наш IBAN рахунок або оплати карткою через Stripe чи PayPal.' },
  ...
  en: {
    ...
    hero: {
      ...
      title: 'Navi.training',
      lead: 'Yacht training, charter, sailboat delivery, expertise.',
      cta: 'Apply',
    },
    mission: {
