...
export function renderSiteFooter(locale = 'ru') {
  ...
  return `<footer class="navi-evo-footer" aria-label="${copy.footer}">
    <div class="navi-evo-footer__intro">
      ...
      <p class="navi-evo-kicker">Navi.training</p><h2>${copy.slogan}</h2><button type="button" class="navi-evo-contact" data-open-service-form data-service="charter" data-navi-formbutton style="background:transparent;border-top:0;border-right:0;border-left:0;padding:0 0 6px;cursor:pointer;">${copy.action}</button>
